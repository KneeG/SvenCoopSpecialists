//////////////////////////////////////////////////////
// File         : weapon_ts_uzi.as                  //
// Author       : Knee                              //
// Description  : UZI from The Specialists Mod 3.0  //
//////////////////////////////////////////////////////
...
namespace TS_Uzi
{
    ...
    namespace Animations
    {
        ...
        const int TILT_SIDEWAYS     = 8 ; 
        const int TILT_UPRIGHT      = 9 ;
        const int SHOOT_SIDEWAYS1   = 10;
        const int SHOOT_SIDEWAYS2   = 11;
        const int SHOOT_SIDEWAYS3   = 12;
        const int SHOOT_SIDEWAYS4   = 13;
        const int RELOAD_SIDEWAYS1  = 14;
    }
    ...
    // Meta data
    const string            strNAME                 = "uzi"             ;
    const string            strNAMESPACE            = "TS_Uzi::"        ;
    const string            strCLASSNAME            = "weapon_ts_uzi"   ;
    ...
    const array<int> arrSidewaysAnimationList = {
        ...
        Animations::SHOOT_SIDEWAYS3,
        Animations::SHOOT_SIDEWAYS4
    };
    
    const float             fHOLSTER_TIME           = TheSpecialists::fDEFAULT_HOSTER_TIME              ;
    const float             fNEXT_THINK             = TheSpecialists::fDEFAULT_NEXT_THINK               ;
    const float             fPRIMARY_ATTACK_DELAY   = TheSpecialists::fWEAPON__UZI__ATTACK_DELAY        ;
    const float             fSWING_DISTANCE         = TheSpecialists::fSWING_DISTANCE                   ;
    const IGNORE_MONSTERS   eIGNORE_RULE            = TheSpecialists::eIGNORE_RULE                      ;
    const int               iDAMAGE                 = TheSpecialists::iWEAPON__UZI__DAMAGE              ;
    const Vector            vecSPREAD               = TheSpecialists::vecWEAPON__UZI__SPREAD            ;
    const float             fRECOIL_MULTIPLIER      = TheSpecialists::fWEAPON__UZI__RECOIL_MULTIPLIER   ;
    
    /////////////////////////////////////
    // UZI class
    class weapon_ts_uzi : ScriptBasePlayerWeaponEntity
    {
        ...
        TraceResult     m_trHit                 ; // Keeps track of what is hit when the uzi is swung
        ...
        void Spawn()
        {
            ...
            // Set the clip size
            self.m_iClip = TheSpecialists::iWEAPON__UZI__CLIP;
        ...
        {
            info.iMaxClip		= TheSpecialists::iWEAPON__UZI__CLIP    ;
            info.iMaxAmmo1		= TheSpecialists::iWEAPON__UZI__AMMO1   ;
            info.iMaxAmmo2		= TheSpecialists::iWEAPON__UZI__AMMO2   ;
            info.iSlot			= TheSpecialists::iWEAPON__SLOT__SMG    ;
            info.iPosition		= TheSpecialists::iWEAPON__POSITION__UZI;
        ...
        bool AddToPlayer(CBasePlayer@ pPlayer)
        {
            ...
            if(bReturn)
            {
                ...
                // Debug printing
                // g_EngineFuncs.ClientPrintf(m_pPlayer, print_console, "UZI m_iPrimaryAmmoType: " + self.m_iPrimaryAmmoType + "\n");
        ...
        void Holster(int skiplocal)
        {
            ...
            // Tell the game loop to stop calling any of our uzi functions
            SetThink(null);
        } // End of Holster()
        
        //////////////////////////////////////////////////
        // TS_Uzi::PrimaryAttack                        //
        // Function:                                    //
        ...
        void Reload()
        {
            ...
            if (    (self.m_iClip == TheSpecialists::iWEAPON__UZI__CLIP)
            ...
            if (m_bSideways)                
            {
                self.DefaultReload(TheSpecialists::iWEAPON__UZI__CLIP, Animations::RELOAD_SIDEWAYS1, 1.5, 0);
            }
            else
            {
                self.DefaultReload(TheSpecialists::iWEAPON__UZI__CLIP, Animations::RELOAD1, 1.5, 0);
            }

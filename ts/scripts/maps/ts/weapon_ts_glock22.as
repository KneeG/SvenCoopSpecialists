...
namespace TS_Glock22
{
    ...
    const Vector            vecSPREAD               = TheSpecialists::vecWEAPON__GLOCK22__SPREAD    ;
    ...
    class weapon_ts_glock22 : ScriptBasePlayerWeaponEntity
    {
        ...
        {
            info.iMaxClip		= TheSpecialists::iWEAPON__GLOCK22__CLIP        ;
            info.iMaxAmmo1		= TheSpecialists::iWEAPON__GLOCK22__AMMO1       ;
            info.iMaxAmmo2		= TheSpecialists::iWEAPON__GLOCK22__AMMO2       ;
        ...
        void Reload()
        {
            ...
            if (    (self.m_iClip == TheSpecialists::iWEAPON__GLOCK22__CLIP)

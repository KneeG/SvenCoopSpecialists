//////////////////////////////////////////////////////
// File         : weapon_ts_mp7.as                  //
// Author       : Knee                              //
// Description  : MP7 from The Specialists Mod 3.0  //
//////////////////////////////////////////////////////
...
namespace TS_MP7
{
    ...
    // Meta data
    const string            strNAME                 = "mp7"             ;
    const string            strNAMESPACE            = "TS_MP7::"        ;
    const string            strCLASSNAME            = "weapon_ts_mp7"   ;
    ...
    const float             fPRIMARY_ATTACK_DELAY   = TheSpecialists::fWEAPON__MP7__ATTACK_DELAY        ;
    const float             fSWING_DISTANCE         = TheSpecialists::fSWING_DISTANCE                   ;
    const IGNORE_MONSTERS   eIGNORE_RULE            = TheSpecialists::eIGNORE_RULE                      ;
    const int               iDAMAGE                 = TheSpecialists::iWEAPON__MP7__DAMAGE              ;
    const Vector            vecSPREAD               = TheSpecialists::vecWEAPON__MP7__SPREAD            ;
    const float             fRECOIL_MULTIPLIER      = TheSpecialists::fWEAPON__MP7__RECOIL_MULTIPLIER   ;
    
    /////////////////////////////////////
    // MP7 class
    class weapon_ts_mp7 : ScriptBasePlayerWeaponEntity
    {
        ...
        void Spawn()
        {
            ...
            // Set the clip size
            self.m_iClip = TheSpecialists::iWEAPON__MP7__CLIP;
        ...
        bool AddToPlayer(CBasePlayer@ pPlayer)
        {
            ...
            if(bReturn)
            {
                ...
                // Debug printing
                // g_EngineFuncs.ClientPrintf(m_pPlayer, print_console, "MP7 m_iPrimaryAmmoType: " + self.m_iPrimaryAmmoType + "\n");
        ...
        void Holster(int skiplocal)
        {
            ...
            // Tell the game loop to stop calling any of our mp7 functions
            SetThink(null);
        } // End of Holster()
        ...
        void Reload()
        {
            ...
            if (    (self.m_iClip == TheSpecialists::iWEAPON__MP7__CLIP)
                 || (m_pPlayer.m_rgAmmo(self.m_iPrimaryAmmoType) <= 0)    )
            {
                return;
            }
            
            self.DefaultReload(TheSpecialists::iWEAPON__MP7__CLIP, Animations::RELOAD1, 1.5, 0);

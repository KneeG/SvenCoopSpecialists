...
namespace TS_Benelli
{
    ...
    namespace Animations
    {
        const int IDLE1             = 0 ;
        const int IDLE2             = 1 ;
        const int RELOAD_LIFT_GUN   = 2 ;
        const int RELOAD_LOAD_SHELL = 3 ;
        const int RELOAD_PUMP       = 4 ;
        const int DRAW1             = 5 ;
        const int SHOOT1            = 6 ; // Shoot pump - Haven't seen a meaningful difference between these two
        ...
        void Shoot()
        {
            ...
            if (TheSpecialists::CommonFunctions::IsAboveWater(m_pPlayer.pev.waterlevel))
            {
                ...
                if (self.m_iClip > 0)
                {
                    ...
                    iRandomAnimation = TheSpecialists::CommonFunctions::PickRandomElementFromListInt(arrShootAnimationList);

//////////////////////////////////////////////////////////
// File         : weapon_ts_skorpion.as                 //
// Author       : Knee                                  //
// Description  : Skorpion from The Specialists Mod 3.0 //
//////////////////////////////////////////////////////////
#include "../../library/thespecialists"

/////////////////////////////////////
// TS_Skorpion namespace
namespace TS_Skorpion
{
    /////////////////////////////////////
    // Skorpion animation enumeration
    namespace Animations
    {
        ...
        const int SHOOT2    = 4;
        const int SHOOT3    = 5;
        const int IDLE_ADS1 = 6; // Won't be using
    }
    ...
    // Meta data
    const string            strNAME                 = "skorpion"             ;
    const string            strNAMESPACE            = "TS_Skorpion::"        ;
    const string            strCLASSNAME            = "weapon_ts_skorpion"   ;
    ...
    const float             fPRIMARY_ATTACK_DELAY   = TheSpecialists::fWEAPON__SKORPION__ATTACK_DELAY       ;
    const float             fSWING_DISTANCE         = TheSpecialists::fSWING_DISTANCE                       ;
    const IGNORE_MONSTERS   eIGNORE_RULE            = TheSpecialists::eIGNORE_RULE                          ;
    const int               iDAMAGE                 = TheSpecialists::iWEAPON__SKORPION__DAMAGE             ;
    const Vector            vecSPREAD               = TheSpecialists::vecWEAPON__SKORPION__SPREAD           ;
    const float             fRECOIL_MULTIPLIER      = TheSpecialists::fWEAPON__SKORPION__RECOIL_MULTIPLIER  ;
    
    /////////////////////////////////////
    // SKORPION class
    class weapon_ts_skorpion : ScriptBasePlayerWeaponEntity
    {
        ...
        TraceResult     m_trHit                 ; // Keeps track of what is hit when the skorpion is swung
        ...
        void Spawn()
        {
            ...
            // Set the clip size
            self.m_iClip = TheSpecialists::iWEAPON__SKORPION__CLIP;
        ...
        {
            info.iMaxClip		= TheSpecialists::iWEAPON__SKORPION__CLIP       ;
            info.iMaxAmmo1		= TheSpecialists::iWEAPON__SKORPION__AMMO1      ;
            info.iMaxAmmo2		= TheSpecialists::iWEAPON__SKORPION__AMMO2      ;
            info.iSlot			= TheSpecialists::iWEAPON__SLOT__SMG            ;
            info.iPosition		= TheSpecialists::iWEAPON__POSITION__SKORPION   ;
        ...
        bool AddToPlayer(CBasePlayer@ pPlayer)
        {
            ...
            if(bReturn)
            {
                ...
                // Debug printing
                // g_EngineFuncs.ClientPrintf(m_pPlayer, print_console, "SKORPION m_iPrimaryAmmoType: " + self.m_iPrimaryAmmoType + "\n");
        ...
        void Holster(int skiplocal)
        {
            ...
            // Tell the game loop to stop calling any of our skorpion functions
            SetThink(null);
        } // End of Holster()
        
        //////////////////////////////////////////////////
        // TS_Skorpion::PrimaryAttack                   //
        // Function:                                    //
        ...
        void Reload()
        {
            ...
            if (    (self.m_iClip == TheSpecialists::iWEAPON__SKORPION__CLIP)
                 || (m_pPlayer.m_rgAmmo(self.m_iPrimaryAmmoType) <= 0)    )
            {
                return;
            }
            
            self.DefaultReload(TheSpecialists::iWEAPON__SKORPION__CLIP, Animations::RELOAD1, 0.5, 0);
    ...
    } // End of class weapon_ts_skorpion

//////////////////////////////////////////////////////////
// File         : weapon_ts_usas12.as                   //
// Author       : Knee                                  //
// Description  : USAS12 from The Specialists Mod 3.0   //
//////////////////////////////////////////////////////////
...
namespace TS_USAS12
{
    ...
    // Meta data
    const string            strNAME                 = "usas12"             ;
    const string            strNAMESPACE            = "TS_USAS12::"        ;
    const string            strCLASSNAME            = "weapon_ts_usas12"   ;
    ...
    const string            strSOUND_CLIPIN         = TheSpecialists::strSOUND_PATH + "shotguns/" + strNAME + "/" + TheSpecialists::strSMG__SOUND__CLIPIN         ;
    const string            strSOUND_CLIPOUT        = TheSpecialists::strSOUND_PATH + "shotguns/" + strNAME + "/" + TheSpecialists::strSMG__SOUND__CLIPOUT        ;
    const string            strSOUND_FIRE           = TheSpecialists::strSOUND_PATH + "shotguns/" + strNAME + "/" + TheSpecialists::strSMG__SOUND__FIRE           ;
    const string            strSOUND_FIRE_SILENCED  = TheSpecialists::strSOUND_PATH + "shotguns/" + strNAME + "/" + TheSpecialists::strSMG__SOUND__FIRE_SILENCED  ;
    const string            strSOUND_SLIDEBACK      = TheSpecialists::strSOUND_PATH + "shotguns/" + strNAME + "/" + TheSpecialists::strSMG__SOUND__SLIDEBACK      ;
    ...
    const float             fPRIMARY_ATTACK_DELAY   = TheSpecialists::fWEAPON__USAS12__ATTACK_DELAY     ;
    const float             fSWING_DISTANCE         = TheSpecialists::fSWING_DISTANCE                   ;
    const IGNORE_MONSTERS   eIGNORE_RULE            = TheSpecialists::eIGNORE_RULE                      ;
    const int               iDAMAGE                 = TheSpecialists::iWEAPON__USAS12__DAMAGE           ;
    const Vector            vecSPREAD               = TheSpecialists::vecWEAPON__USAS12__SPREAD         ;
    const float             fRECOIL_MULTIPLIER      = TheSpecialists::fWEAPON__USAS12__RECOIL_MULTIPLIER;
    
    /////////////////////////////////////
    // USAS12 class
    class weapon_ts_usas12 : ScriptBasePlayerWeaponEntity
    {
        ...
        TraceResult     m_trHit                 ; // Keeps track of what is hit when the usas12 is swung
        ...
        void Spawn()
        {
            ...
            // Set the clip size
            self.m_iClip = TheSpecialists::iWEAPON__USAS12__CLIP;
        ...
        {
            info.iMaxClip   = TheSpecialists::iWEAPON__USAS12__CLIP     ;
            info.iMaxAmmo1  = TheSpecialists::iWEAPON__USAS12__AMMO1    ;
            info.iMaxAmmo2  = TheSpecialists::iWEAPON__USAS12__AMMO2    ;
            info.iSlot      = TheSpecialists::iWEAPON__SLOT__RIFLE      ;
            info.iPosition  = TheSpecialists::iWEAPON__POSITION__USAS12 ;
        ...
        bool AddToPlayer(CBasePlayer@ pPlayer)
        {
            ...
            if(bReturn)
            {
                ...
                // Debug printing
                // g_EngineFuncs.ClientPrintf(m_pPlayer, print_console, "USAS12 m_iPrimaryAmmoType: " + self.m_iPrimaryAmmoType + "\n");
        ...
        void Holster(int skiplocal)
        {
            ...
            // Tell the game loop to stop calling any of our usas12 functions
            SetThink(null);
        } // End of Holster()
        
        //////////////////////////////////////////////////
        // TS_USAS12::PrimaryAttack                     //
        // Function:                                    //
        ...
        void Reload()
        {
            ...
            if (    (self.m_iClip == TheSpecialists::iWEAPON__USAS12__CLIP)
                 || (m_pPlayer.m_rgAmmo(self.m_iPrimaryAmmoType) <= 0)    )
            {
                return;
            }
            
            self.DefaultReload(TheSpecialists::iWEAPON__USAS12__CLIP, Animations::RELOAD1, 1.5, 0);

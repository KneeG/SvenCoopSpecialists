//////////////////////////////////////////////////////////////
// File         : weapon_ts_contender.as                  //
// Author       : Knee                                      //
// Description  : Contender from The Specialists Mod 3.0  //
//////////////////////////////////////////////////////////////
#include "../../library/thespecialists"

/////////////////////////////////////
// TS_Contender namespace
namespace TS_Contender
{
    /////////////////////////////////////
    // Contender animation enumeration
    ...
    // Meta data
    const string            strNAME                 = "contender"             ;
    const string            strNAMESPACE            = "TS_Contender::"        ;
    const string            strCLASSNAME            = "weapon_ts_contender"   ;
    ...
    const float             fPRIMARY_ATTACK_DELAY   = TheSpecialists::fWEAPON__CONTENDER__ATTACK_DELAY  ;
    const float             fSWING_DISTANCE         = TheSpecialists::fSWING_DISTANCE                   ;
    const IGNORE_MONSTERS   eIGNORE_RULE            = TheSpecialists::eIGNORE_RULE                      ;
    const int               iDAMAGE                 = TheSpecialists::iWEAPON__CONTENDER__DAMAGE        ;
    const Vector            vecSPREAD               = TheSpecialists::vecWEAPON__CONTENDER__SPREAD      ;
    
    /////////////////////////////////////
    // Contender class
    class weapon_ts_contender : ScriptBasePlayerWeaponEntity
    {
        ...
        private int     m_bScoped               ; // Silenced flag
        ...
        TraceResult m_trHit                     ; // Keeps track of what is hit when the contender is swung
        ...
        {
            info.iMaxClip		= TheSpecialists::iWEAPON__CONTENDER__CLIP      ;
            info.iMaxAmmo1		= TheSpecialists::iWEAPON__CONTENDER__AMMO1     ;
            info.iMaxAmmo2		= TheSpecialists::iWEAPON__CONTENDER__AMMO2     ;
            info.iSlot			= TheSpecialists::iWEAPON__SLOT__PISTOL         ;
            info.iPosition		= TheSpecialists::iWEAPON__POSITION__CONTENDER  ;
        ...
        bool AddToPlayer(CBasePlayer@ pPlayer)
        {
            ...
            if(bReturn)
            {
                ...
                // Debug printing
                // g_EngineFuncs.ClientPrintf(m_pPlayer, print_console, "Contender m_iPrimaryAmmoType: " + self.m_iPrimaryAmmoType + "\n");
        ...
        void Holster(int skiplocal)
        {
            ...
            // Tell the looping function to stop calling any of our contender functions
            SetThink(null);
        } // End of Holster()
        
        //////////////////////////////////////////////////
        // TS_Contender::PrimaryAttack                  //
        // Function:                                    //
            ...
            if (TheSpecialists::CommonFunctions::IsAboveWater(m_pPlayer.pev.waterlevel))
            {
                ...
                if (self.m_iClip > 0)
                {
                    ...
                    (
                        ...
                        TheSpecialists::iWEAPON__PISTOL_762__BULLET__TYPE   , // int iBulletType        - Bullet type, not sure what this means
        ...
        void Reload()
        {
            ...
            if (    (self.m_iClip == TheSpecialists::iWEAPON__CONTENDER__CLIP)
                 || (m_pPlayer.m_rgAmmo(self.m_iPrimaryAmmoType) <= 0)    )
            {
                return;
            }
            
            self.DefaultReload(TheSpecialists::iWEAPON__CONTENDER__CLIP, Animations::RELOAD1, 1.5, 0);
    ...
    } // End of class weapon_ts_contender
    ...
    void Register_Weapon()
    {
        ...
        (
            ...
            TheSpecialists::strWEAPON__PISTOL_762__AMMO_TYPE  // string - ammo type
        );
    }
} // End of namespace TS_Contender
//////////////////////////////////////////////////////////
// File         : weapon_ts_aug.as                    //
// Author       : Knee                                  //
// Description  : AUG from The Specialists Mod 3.0    //
//////////////////////////////////////////////////////////
...
namespace TS_AUG
{
    ...
    // Meta data
    const string            strNAME                 = "aug"             ;
    const string            strNAMESPACE            = "TS_AUG::"        ;
    const string            strCLASSNAME            = "weapon_ts_aug"   ;
    ...
    const float             fPRIMARY_ATTACK_DELAY   = TheSpecialists::fWEAPON__AUG__ATTACK_DELAY        ;
    const float             fSWING_DISTANCE         = TheSpecialists::fSWING_DISTANCE                   ;
    const IGNORE_MONSTERS   eIGNORE_RULE            = TheSpecialists::eIGNORE_RULE                      ;
    const int               iDAMAGE                 = TheSpecialists::iWEAPON__AUG__DAMAGE              ;
    const Vector            vecSPREAD               = TheSpecialists::vecWEAPON__AUG__SPREAD            ;
    const float             fRECOIL_MULTIPLIER      = TheSpecialists::fWEAPON__AUG__RECOIL_MULTIPLIER   ;
    
    /////////////////////////////////////
    // AUG class
    class weapon_ts_aug : ScriptBasePlayerWeaponEntity
    {
        ...
        private bool    m_bSilenced             ; // Flag for the suppressor
        ...
        TraceResult     m_trHit                 ; // Keeps track of what is hit when the aug is swung
        ...
        void Spawn()
        {
            ...
            m_fAttackDelay = TheSpecialists::fWEAPON__AUG__ATTACK_DELAY;
            ...
            // Set the clip size
            self.m_iClip = TheSpecialists::iWEAPON__AUG__CLIP;
        ...
        {
            info.iMaxClip		= TheSpecialists::iWEAPON__AUG__CLIP    ;
            info.iMaxAmmo1		= TheSpecialists::iWEAPON__AUG__AMMO1   ;
            info.iMaxAmmo2		= TheSpecialists::iWEAPON__AUG__AMMO2   ;
            info.iSlot			= TheSpecialists::iWEAPON__SLOT__RIFLE  ;
            info.iPosition		= TheSpecialists::iWEAPON__POSITION__AUG;
        ...
        bool AddToPlayer(CBasePlayer@ pPlayer)
        {
            ...
            if(bReturn)
            {
                ...
                // Debug printing
                // g_EngineFuncs.ClientPrintf(m_pPlayer, print_console, "AUG m_iPrimaryAmmoType: " + self.m_iPrimaryAmmoType + "\n");
        ...
        void Holster(int skiplocal)
        {
            ...
            // Tell the game loop to stop calling any of our aug functions
            SetThink(null);
        } // End of Holster()
        
        //////////////////////////////////////////////////
        // TS_AUG::PrimaryAttack                        //
        // Function:                                    //
        ...
        void SecondaryAttack()
        {
            ...
            else
            {
                ...
                m_fAttackDelay = TheSpecialists::fWEAPON__AUG__ATTACK_DELAY__ZOOM;
            }
        ...
        void Reload()
        {
            ...
            if (    (self.m_iClip == TheSpecialists::iWEAPON__AUG__CLIP)
                 || (m_pPlayer.m_rgAmmo(self.m_iPrimaryAmmoType) <= 0)    )
            {
                return;
            }
            
            self.DefaultReload(TheSpecialists::iWEAPON__AUG__CLIP, Animations::RELOAD1, 1.5, 0);

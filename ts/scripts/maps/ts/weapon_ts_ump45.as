//////////////////////////////////////////////////////////
// File         : weapon_ts_ump45.as                    //
// Author       : Knee                                  //
// Description  : UMP45 from The Specialists Mod 3.0    //
//////////////////////////////////////////////////////////
...
namespace TS_UMP45
{
    ...
    // Meta data
    const string            strNAME                 = "ump45"             ;
    const string            strNAMESPACE            = "TS_UMP45::"        ;
    const string            strCLASSNAME            = "weapon_ts_ump45"   ;
    ...
    const float             fPRIMARY_ATTACK_DELAY   = TheSpecialists::fWEAPON__UMP45__ATTACK_DELAY      ;
    const float             fSWING_DISTANCE         = TheSpecialists::fSWING_DISTANCE                   ;
    const IGNORE_MONSTERS   eIGNORE_RULE            = TheSpecialists::eIGNORE_RULE                      ;
    const int               iDAMAGE                 = TheSpecialists::iWEAPON__UMP45__DAMAGE            ;
    const Vector            vecSPREAD               = TheSpecialists::vecWEAPON__UMP45__SPREAD          ;
    const float             fRECOIL_MULTIPLIER      = TheSpecialists::fWEAPON__UMP45__RECOIL_MULTIPLIER ;
    
    /////////////////////////////////////
    // UMP45 class
    class weapon_ts_ump45 : ScriptBasePlayerWeaponEntity
    {
        ...
        TraceResult     m_trHit                 ; // Keeps track of what is hit when the ump45 is swung
        ...
        void Spawn()
        {
            ...
            // Set the clip size
            self.m_iClip = TheSpecialists::iWEAPON__UMP45__CLIP;
        ...
        {
            info.iMaxClip		= TheSpecialists::iWEAPON__UMP45__CLIP      ;
            info.iMaxAmmo1		= TheSpecialists::iWEAPON__UMP45__AMMO1     ;
            info.iMaxAmmo2		= TheSpecialists::iWEAPON__UMP45__AMMO2     ;
            info.iSlot			= TheSpecialists::iWEAPON__SLOT__SMG        ;
            info.iPosition		= TheSpecialists::iWEAPON__POSITION__UMP45  ;
        ...
        bool AddToPlayer(CBasePlayer@ pPlayer)
        {
            ...
            if(bReturn)
            {
                ...
                // Debug printing
                // g_EngineFuncs.ClientPrintf(m_pPlayer, print_console, "UMP45 m_iPrimaryAmmoType: " + self.m_iPrimaryAmmoType + "\n");
        ...
        void Holster(int skiplocal)
        {
            ...
            // Tell the game loop to stop calling any of our ump45 functions
            SetThink(null);
        } // End of Holster()
        
        //////////////////////////////////////////////////
        // TS_UMP45::PrimaryAttack                      //
        // Function:                                    //
        ...
        void Reload()
        {
            ...
            if (    (self.m_iClip == TheSpecialists::iWEAPON__UMP45__CLIP)
                 || (m_pPlayer.m_rgAmmo(self.m_iPrimaryAmmoType) <= 0)    )
            {
                return;
            }
            
            self.DefaultReload(TheSpecialists::iWEAPON__UMP45__CLIP, Animations::RELOAD1, 1.5, 0);
